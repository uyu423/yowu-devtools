...
export const jaJP = {
  ...
  tool: {
    ...
    hash: {
      ...
      securityNote: '注: チェックサム検証用のみ。セキュリティ目的には適していません。',
      securityWarning: 'セキュリティ警告: {alg}は暗号学的に脆弱です。セキュリティ目的にはSHA-256またはSHA-512を使用してください。',
    ...
    regex: {
      ...
      securityNote: '注: このツールはJavaScript RegExpエンジンを使用します。複雑なパターンに注意してください。',
