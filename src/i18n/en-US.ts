...
export const enUS = {
  ...
  tool: {
    ...
    hash: {
      ...
      securityNote: 'Note: For checksum verification only. Not suitable for security purposes.',
      securityWarning: 'Security Warning: {alg} is cryptographically broken and should not be used for security purposes. Use SHA-256 or SHA-512.',
    ...
    regex: {
      ...
      securityNote: 'Note: This tool uses JavaScript RegExp engine. Be cautious with complex patterns.',
