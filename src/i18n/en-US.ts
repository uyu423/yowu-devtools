...
export const enUS = {
  ...
  pwa: {
    ...
    newVersionDescription: 'A new version of the app is available. Update now to get the latest features.',
  ...
  homepage: {
    ...
    privacyFirstDescription: 'everything runs in your browser. No data sent to servers, no tracking, no analytics. Your sensitive data stays on your machine.',
    fastEfficient: 'Fast and efficient',
    fastEfficientDescription: 'Command Palette for quick navigation, file drag & drop support, and Web Workers for handling large datasets without freezing your browser.',
    installablePwa: 'Installable PWA',
    installablePwaDescription: 'works offline, installs as a standalone app, and automatically updates when new versions are available.',
    openAuditable: 'Open and auditable',
    openAuditableDescription: 'every line of code is public. You can verify what each tool does and how it processes your data.',
    hostedOn: 'Hosted on GitHub Pages as a static site. All processing happens in your browser.',
    viewOnGithub: 'View on GitHub',
    quickNavigation: 'Quick Navigation',
    quickNavigationDescription: 'Press {cmdK} or {ctrlK} to open the Command Palette and quickly find any tool.',
  ...
  tool: {
    ...
    uuid: {
      ...
      uuidV4Desc: 'Completely random UUID. Best for unique identifiers where ordering does not matter.',
      uuidV7Desc: 'Timestamp-based UUID. Naturally sortable by generation time.',
      ulidDesc: '26-character identifier. Lexicographically sortable, shorter than UUID.',
      lowercase: 'lowercase',
      uppercase: 'UPPERCASE',
    ...
    regex: {
      ...
      specCharacterClassesDesc: 'Predefined character sets for matching specific types of characters',
      specQuantifiers: 'Quantifiers',
      specQuantifiersDesc: 'Specify how many times a character, group, or character class should be matched',
      specAnchors: 'Anchors',
      specAnchorsDesc: 'Assert positions in the string without consuming characters',
      specGroups: 'Groups',
      specGroupsDesc: 'Group parts of a pattern together and capture or reference them',
      ...
      patternNonDigitDesc: 'Matches any character that is not a digit. Equivalent to [^0-9].',
      patternNonDigitExample: '\\D+ matches one or more non-digit characters',
      patternWordCharName: 'Word Character',
      patternWordCharDesc: 'Matches any word character (alphanumeric plus underscore). Equivalent to [A-Za-z0-9_].',
      patternWordCharExample: '\\w+ matches one or more word characters',
      patternNonWordCharName: 'Non-word Character',
      patternNonWordCharDesc: 'Matches any non-word character. Equivalent to [^A-Za-z0-9_].',
      patternNonWordCharExample: '\\W+ matches one or more non-word characters',
      patternWhitespaceName: 'Whitespace',
      patternWhitespaceDesc: 'Matches any whitespace character (space, tab, newline, etc.).',
      patternWhitespaceExample: '\\s+ matches one or more whitespace characters',
      patternNonWhitespaceName: 'Non-whitespace',
      patternNonWhitespaceDesc: 'Matches any non-whitespace character.',
      patternNonWhitespaceExample: '\\S+ matches one or more non-whitespace characters',
      patternDotEscapedName: 'Dot (Escaped)',
      patternDotEscapedDesc: 'Matches a literal dot character. The dot (.) without escape matches any character except newline.',
      ...
      patternZeroOrMoreDesc: 'Matches zero or more occurrences of the preceding element.',
      patternZeroOrMoreExample: "a* matches zero or more 'a' characters",
      patternOneOrMoreName: 'One or More',
      patternOneOrMoreDesc: 'Matches one or more occurrences of the preceding element.',
      patternOneOrMoreExample: "a+ matches one or more 'a' characters",
      patternZeroOrOneName: 'Zero or One',
      patternZeroOrOneDesc: 'Matches zero or one occurrence of the preceding element (makes it optional).',
      patternZeroOrOneExample: "a? matches zero or one 'a' character",
      patternExactlyNName: 'Exactly N',
      patternExactlyNDesc: 'Matches exactly n occurrences of the preceding element.',
      patternExactlyNExample: "a{3} matches exactly three 'a' characters",
      patternNOrMoreName: 'N or More',
      patternNOrMoreDesc: 'Matches n or more occurrences of the preceding element.',
      patternNOrMoreExample: "a{3,} matches three or more 'a' characters",
      patternBetweenNMName: 'Between N and M',
      patternBetweenNMDesc: 'Matches between n and m occurrences of the preceding element.',
      patternBetweenNMExample: "a{3,5} matches between three and five 'a' characters",
      patternLazyZeroOrMoreName: 'Lazy Zero or More',
      patternLazyZeroOrMoreDesc: 'Non-greedy (lazy) version of *. Matches as few characters as possible.',
      patternLazyZeroOrMoreExample: "a*? matches zero or more 'a' characters (lazy)",
      patternLazyOneOrMoreName: 'Lazy One or More',
      patternLazyOneOrMoreDesc: 'Non-greedy (lazy) version of +. Matches as few characters as possible.',
      patternLazyOneOrMoreExample: "a+? matches one or more 'a' characters (lazy)",
      patternLazyZeroOrOneName: 'Lazy Zero or One',
      patternLazyZeroOrOneDesc: 'Non-greedy (lazy) version of ?.',
      patternLazyZeroOrOneExample: "a?? matches zero or one 'a' character (lazy)",
      // Pattern descriptions - Anchors
      patternStartOfStringName: 'Start of String',
      patternStartOfStringDesc: "Matches the start of the string (or start of line with 'm' flag).",
      patternStartOfStringExample: "^abc matches 'abc' at the start of the string",
      patternEndOfStringName: 'End of String',
      patternEndOfStringDesc: "Matches the end of the string (or end of line with 'm' flag).",
      patternEndOfStringExample: "abc$ matches 'abc' at the end of the string",
      patternWordBoundaryName: 'Word Boundary',
      patternWordBoundaryDesc: 'Matches a word boundary (between a word character and a non-word character).',
      patternWordBoundaryExample: "\\bword\\b matches 'word' as a whole word",
      patternNonWordBoundaryName: 'Non-word Boundary',
      patternNonWordBoundaryDesc: 'Matches a position that is not a word boundary.',
      patternNonWordBoundaryExample: "\\Bword\\B matches 'word' not at word boundaries",
      // Pattern descriptions - Groups
      patternCapturingGroupName: 'Capturing Group',
      patternCapturingGroupDesc: 'Groups and captures the matched text. Can be referenced with $1, $2, etc.',
      patternCapturingGroupExample: "(abc) captures 'abc' as group 1",
      patternNonCapturingGroupName: 'Non-capturing Group',
      patternNonCapturingGroupDesc: 'Groups without capturing. Useful for applying quantifiers without creating a capture group.',
      patternNonCapturingGroupExample: "(?:abc) groups 'abc' without capturing",
      patternNamedCapturingGroupName: 'Named Capturing Group',
      patternNamedCapturingGroupDesc: 'Creates a named capture group that can be referenced by name.',
      patternNamedCapturingGroupExample: "(?<name>abc) captures 'abc' as group named 'name'",
      patternPositiveLookaheadName: 'Positive Lookahead',
      patternPositiveLookaheadDesc: "Asserts that what follows matches the pattern, but doesn't consume characters.",
      patternPositiveLookaheadExample: "abc(?=def) matches 'abc' only if followed by 'def'",
      patternNegativeLookaheadName: 'Negative Lookahead',
      patternNegativeLookaheadDesc: 'Asserts that what follows does NOT match the pattern.',
      patternNegativeLookaheadExample: "abc(?!def) matches 'abc' only if NOT followed by 'def'",
      patternPositiveLookbehindName: 'Positive Lookbehind',
      patternPositiveLookbehindDesc: "Asserts that what precedes matches the pattern, but doesn't consume characters.",
      patternPositiveLookbehindExample: "(?<=abc)def matches 'def' only if preceded by 'abc'",
      patternNegativeLookbehindName: 'Negative Lookbehind',
      patternNegativeLookbehindDesc: 'Asserts that what precedes does NOT match the pattern.',
      patternNegativeLookbehindExample: "(?<!abc)def matches 'def' only if NOT preceded by 'abc'",
      patternBackreferenceName: 'Backreference',
      patternBackreferenceDesc: 'References a previously captured group by number.',
      patternBackreferenceExample: "(abc)\\1 matches 'abcabc'",
      patternNamedBackreferenceName: 'Named Backreference',
      patternNamedBackreferenceDesc: 'References a previously captured named group.',
      patternNamedBackreferenceExample: "(?<name>abc)\\k<name> matches 'abcabc'",
      // Pattern descriptions - Character Sets
      patternCharacterClassName: 'Character Class',
      patternCharacterClassDesc: 'Matches any one character from the set. Use ^ at the start to negate.',
      ...
      patternNegatedCharacterClassExample: "[^abc] matches any character except 'a', 'b', or 'c'",
      ...
      patternGlobalFlagDesc: 'Find all matches rather than stopping after the first match.',
      ...
      patternCaseInsensitiveFlagExample: "/pattern/i matches 'Pattern', 'PATTERN', etc.",
      patternMultilineFlagName: 'Multiline',
      patternMultilineFlagDesc: 'Makes ^ and $ match the start/end of each line, not just the string.',
      patternMultilineFlagExample: "/^pattern$/m matches 'pattern' at the start of any line",
      ...
      patternUnicodeFlagDesc: 'Enables full Unicode matching. Treats pattern as a sequence of Unicode code points.',
      patternUnicodeFlagExample: '/\\u{1F600}/u matches Unicode emoji',
      patternStickyFlagName: 'Sticky',
      patternStickyFlagDesc: 'Matches only from the index indicated by the lastIndex property.',
      ...
      patternHasIndicesFlagExample: '/pattern/d includes indices in match results',
      patternUnicodeSetsFlagName: 'UnicodeSets',
      patternUnicodeSetsFlagDesc: 'Enables Unicode set mode with improved character class handling.',
      patternUnicodeSetsFlagExample: '/[\\p{Letter}]/v matches Unicode letter properties',
      // Pattern descriptions - Unicode
      patternUnicodeEscapeName: 'Unicode Escape',
      patternUnicodeEscapeDesc: 'Matches a Unicode character by its code point.',
      patternUnicodeEscapeExample: "\\u0041 matches 'A'",
      patternUnicodeCodePointName: 'Unicode Code Point',
      patternUnicodeCodePointDesc: "Matches a Unicode character by its code point (requires 'u' flag).",
      patternUnicodeCodePointExample: '\\u{1F600} matches 😀',
      patternUnicodePropertyName: 'Unicode Property',
      patternUnicodePropertyDesc: "Matches characters with a specific Unicode property (requires 'u' or 'v' flag).",
      ...
      patternNegatedUnicodePropertyDesc: 'Matches characters without a specific Unicode property.',
      patternNegatedUnicodePropertyExample: '\\P{Letter} matches any non-letter character',
    },
    jwtDecoder: {
      title: 'JWT Decoder',
