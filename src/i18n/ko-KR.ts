...
export const koKR = {
  ...
  tool: {
    ...
    hash: {
      ...
      securityNote: '참고: 체크섬 검증용으로만 사용하세요. 보안 목적에는 적합하지 않습니다.',
      securityWarning: '보안 경고: {alg}은 암호학적으로 취약하므로 보안 목적으로 사용하지 마세요. SHA-256 또는 SHA-512를 사용하세요.',
    ...
    regex: {
      ...
      securityNote: '참고: 이 도구는 JavaScript RegExp 엔진을 사용합니다. 복잡한 패턴에 주의하세요.',
