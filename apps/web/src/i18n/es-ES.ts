...
export const esES = {
  ...
  tool: {
    ...
    apiTester: {
      ...
      extensionConnected: 'Conectado',
      extensionNotInstalled: 'No instalado',
      ...
      corsErrorTitle: 'Solicitud fallida',
      corsErrorDescription: 'Este error puede deberse a restricciones CORS (Cross-Origin Resource Sharing). Los navegadores bloquean solicitudes a diferentes dominios por razones de seguridad.',
