...
export const jaJP = {
  ...
  sidebar: {
    ...
    storageManagerDescription: 'メニューごとの保存データを確認・削除します。',
    storageMenuLabel: 'グループ',
    storageMenuAll: 'すべてのグループ',
    storageMenuUnknown: 'その他',
    storageGroupCommon: '共通設定',
    storageGroupShared: '共有キャッシュ',
    storageGroupTool: 'ツール: {tool}',
    storageGroupLegacy: 'レガシー/その他',
    storageSummary: '{count}件 · {size}',
    storageKey: 'キー',
    storageValuePreview: 'プレビュー',
    storageSize: 'サイズ',
    storageDeleteKey: 'キーを削除',
    storageDeleteMenu: 'このメニューを削除',
    storageDeleteKeyConfirm: '「{key}」を削除しますか？元に戻せません。',
    storageDeleteMenuConfirm: '「{menu}」の{count}件をすべて削除しますか？',
    storageNoData: '保存されたローカルストレージがありません。',
    storageEmptyValue: '（空）',
    storageRefresh: '再読み込み',
    // License info
    license: 'ライセンス',
    sourceCode: 'ソース',
    noWarranty: '保証なし',
  ...
  tool: {
    ...
    apiBurstTest: {
      ...
      bodyHandling: {
        ...
        stream: 'ストリーム',
        full: 'フル',
        cancelDesc: 'ボディダウンロードを完全にスキップ（最速、最小メモリ）',
        streamDesc: 'テキストデコードなしでボディサイズを読み取り（中間）',
        fullDesc: 'フルボディを読み取りデコード（最遅、最も正確なサイズ）',
      },
      headers: 'ヘッダー',
      headerKey: 'ヘッダー',
      headerValue: '値',
      ...
      networkTiming: {
        ...
        protocol: 'プロトコル',
        protocolUnknown: '不明',
        protocolNote: '(Timing-Allow-Origin必要)',
        avgNetworkLatency: '平均ネットワークレイテンシ',
        avgStalled: '平均キュー時間',
