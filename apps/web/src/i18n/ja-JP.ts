...
export const jaJP = {
  ...
  tool: {
    ...
    apiTester: {
      ...
      corsErrorTitle: 'リクエスト失敗',
      corsErrorDescription: 'このエラーは、CORS（Cross-Origin Resource Sharing）制限によって発生した可能性があります。ブラウザはセキュリティ上の理由から、異なるドメインへのリクエストをブロックします。',
