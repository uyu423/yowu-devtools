...
export const koKR = {
  ...
  tool: {
    ...
    iconConverter: {
      ...
      description: 'SVG/이미지를 ICO, PNG, WebP, JPEG로 멀티 사이즈 변환',
      input: {
        dropHere: '이미지를 드래그하거나 클릭하여 선택하세요',
        pickFile: '파일 선택',
        fileMeta: {
          name: '파일명',
          type: '형식',
      ...
      output: {
        format: '출력 형식',
        ico: 'ICO',
        icoDescription: '멀티 사이즈 아이콘 (권장)',
        png: 'PNG',
        pngDescription: '무손실, 투명도 지원',
        webp: 'WebP',
        webpDescription: '현대적, 작은 파일 크기',
        jpeg: 'JPEG',
        jpegDescription: '사진에 최적, 투명도 없음',
        exportZip: 'ZIP으로 내보내기',
        exportZipDescription: '모든 사이즈를 하나의 압축 파일로',
      },
      preset: {
        label: '프리셋',
        ...
        custom: '사용자 지정',
        customDescription: '사이즈 직접 선택',
      },
      sizes: {
        label: '사이즈',
        autoSelected: '(프리셋에 의해 자동 선택)',
        selectAll: '모두 선택',
        deselectAll: '모두 해제',
        selected: '선택됨',
        size: '사이즈',
      ...
      options: {
        ...
        fit: 'Fit 모드',
        contain: 'Contain',
        containDescription: '비율 유지, 패딩 추가',
        cover: 'Cover',
        coverDescription: '비율 유지, 잘림 가능',
        stretch: 'Stretch',
        stretchDescription: '캔버스 채움, 비율 무시',
        padding: '패딩',
        background: '배경',
        transparent: '투명',
        solidColor: '단색',
        quality: '품질',
        qualityLow: '낮음 (작은 파일)',
        qualityHigh: '높음 (더 나은 품질)',
      },
      ico: {
        mode: 'ICO 모드',
        modernPng: 'Modern PNG (권장)',
        compat: 'Compatibility (준비 중)',
      },
      generate: '생성',
      generating: '생성 중...',
      progress: '{current} / {total} 완료',
      processingSize: '{size}×{size} 처리 중...',
      download: {
        title: '다운로드',
        ico: 'ICO 다운로드',
        png: 'PNG 다운로드',
      ...
      preview: {
        title: '미리보기',
        noPreview: '미리보기 없음',
        generateToSee: '아이콘을 생성하여 미리보기를 확인하세요',
        of: '/',
      },
      error: {
        unsupportedFormat: '지원하지 않는 형식: {type}. SVG, PNG, JPG, WebP, AVIF를 사용하세요.',
        fileTooLarge: '파일이 너무 큽니다: {size}MB. 최대: {max}MB.',
        svgExternalRefBlocked: 'SVG에 외부 리소스가 포함되어 있습니다 (보안상 차단)',
        decodeFailed: '이미지 디코딩 실패',
        renderFailed: '이미지 렌더링 실패',
        noSizeSelected: '최소 1개 이상의 사이즈를 선택하세요',
        invalidSize: '사이즈는 1~256 범위여야 합니다',
      },
      warning: {
        largeImage: '큰 이미지는 성능 문제를 일으킬 수 있습니다',
        upscale: '{original}px에서 {target}px로 업스케일하면 품질이 저하될 수 있습니다',
        svgComplexity: '복잡한 SVG는 일부 브라우저에서 제대로 렌더링되지 않을 수 있습니다',
      },
      fileInfo: '파일 정보',
      yes: '예',
      no: '아니오',
  ...
  meta: {
    ...
    iconConverter: {
      title: 'Icon Converter',
      description:
        '무료 온라인 아이콘 변환기. SVG, PNG, JPG를 ICO, PNG, WebP, JPEG로 멀티 사이즈 변환. Windows 앱 아이콘, 파비콘 생성. 모든 처리는 브라우저에서 수행 - 서버로 데이터 전송 없음.',
    },
    apiBurstTest: {
      title: 'API Burst Test',
      description:
