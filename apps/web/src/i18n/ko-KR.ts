...
export const koKR = {
  ...
  tool: {
    ...
    apiTester: {
      ...
      extension: '확장',
      copyAsCurl: 'cURL로 복사',
      extensionConnected: '연결됨',
      extensionNotInstalled: '설치 안됨',
      extensionPermissionRequired: '권한 필요',
      extensionChecking: '확인 중...',
      installExtension: '설치',
      retryWithExtension: 'Extension으로 재시도',
      corsErrorTitle: '요청 실패',
      corsErrorDescription: '이 오류는 CORS(Cross-Origin Resource Sharing) 제한으로 인해 발생했을 수 있습니다. 브라우저는 보안상의 이유로 다른 도메인에 대한 요청을 차단합니다.',
