...
export const enUS = {
  ...
  tool: {
    ...
    apiTester: {
      ...
      corsErrorTitle: 'Request Failed',
      corsErrorDescription: 'This error may be caused by CORS (Cross-Origin Resource Sharing) restrictions. Browsers block requests to different domains for security reasons.',
