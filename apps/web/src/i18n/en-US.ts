...
export const enUS = {
  ...
  tool: {
    ...
    curl: {
      ...
      hideSensitiveTooltip: 'Mask Authorization headers and other sensitive data',
    ...
    apiTester: {
      ...
      installExtensionTooltip: 'Install extension to bypass CORS restrictions. Not needed if the API allows cross-origin requests.',
      extensionPermissionRequired: 'Permission Required',
      extensionChecking: 'Checking...',
      extensionTooltipChecking: 'Verifying extension connection. Please wait...',
      extensionTooltipNotConnected: 'Extension not detected. Install the CORS Helper extension to bypass CORS restrictions. Click to retry detection.',
      extensionTooltipPermissionRequired: 'Extension detected but needs permission for this domain. Click the extension icon and allow access to continue.',
      extensionTooltipConnected: 'Extension connected and ready! CORS restrictions will be bypassed automatically when needed.',
      retryWithExtension: 'Retry with Extension',
      corsErrorTitle: 'CORS Error Detected',
      corsErrorDescription: 'This request was blocked by the browser\'s CORS policy.',
      corsErrorExplanation: 'Browsers block requests to different domains for security. APIs must explicitly allow cross-origin requests, but many don\'t when accessed from web apps.',
      corsWhyExtension: 'Why use an extension?',
      corsWhyExtensionDesc: 'The browser extension can bypass CORS restrictions by making requests from the extension context, which isn\'t subject to the same security rules as web pages.',
      ...
      errorCors: 'Request failed. This may be due to CORS restrictions. Try using Extension mode.',
