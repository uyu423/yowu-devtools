...
export const enUS = {
  ...
  sidebar: {
    ...
    settings: 'Settings',
    storageManager: 'Local storage manager',
    storageManagerDescription: 'Inspect or clear saved local data for each menu.',
    storageMenuLabel: 'Menu',
    storageMenuAll: 'All menus',
    storageMenuUnknown: 'general',
    storageGroupCommon: 'Common settings',
    storageGroupShared: 'Shared cache',
    storageGroupTool: 'Tool: {tool}',
    storageGroupLegacy: 'Legacy / other',
    storageSummary: '{count} items · {size}',
    storageKey: 'Key',
    storageValuePreview: 'Preview',
    storageSize: 'Size',
    storageDeleteKey: 'Delete key',
    storageDeleteMenu: 'Delete menu data',
    storageDeleteKeyConfirm: 'Delete "{key}"? This action cannot be undone.',
    storageDeleteMenuConfirm: 'Delete all {count} items for "{menu}"? This cannot be undone.',
    storageNoData: 'No local storage entries found.',
    storageEmptyValue: '(empty)',
